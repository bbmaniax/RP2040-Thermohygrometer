...
#define PATTERN_DURATION_SEC 15
#define PATTERN_DISPLAY_DURATION_MS 500
#define PATTERN_TICK_COUNT (PATTERN_DURATION_SEC * 1000 / PATTERN_DISPLAY_DURATION_MS)
...
void loop() {
  ...
  display.display();
  delay(PATTERN_DISPLAY_DURATION_MS);

  tickCount = (tickCount + 1) % PATTERN_TICK_COUNT;
  if (tickCount == 0) {
